		...
		<table class="form-table" style="max-width:600px;clear:none;z-index:5;">
			...
			<tr valign="top">
				...
				<td>
					...
					if(file_exists($d2)) echo '<p style="color:#D54E21;">'.__('Up this week', 'rencontre').__(': ','rencontre').'<span style="color:#111;font-weight:700;">'.file_get_contents($d2).'</span>&nbsp;'.__('mail/hour', 'rencontre').'<br />('.__('sent during maintenance', 'rencontre').')</p>';
					?>
				</td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td>
					...
					if(file_exists($d2)) echo '<p style="color:#D54E21;">'.__('Up this week', 'rencontre').__(': ','rencontre').'<span style="color:#111;font-weight:700;">'.file_get_contents($d2).'</span>&nbsp;'.__('mail/hour', 'rencontre').'<br />('.__('except during maintenance', 'rencontre').')</p>';
					?>
				</td>
			</tr>
			<tr valign="top">
